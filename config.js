...
const config = {
  ...
  assets: {
    "haidar-daftar": "./assets/image/haidar-daftar.png",
    "haidar-demote": "./assets/image/haidar-demote.png",
    "haidar-fishit": "./assets/image/haidar-fishit.jpg",
    "haidar-games": "./assets/image/haidar-games.jpg",
    "haidar-landscape": "./assets/image/haidar-landscape.jpg",
    "haidar-levelup": "./assets/image/haidar-levelup.jpg",
    "haidar-minecraft": "./assets/image/haidar-minecraft.jpg",
    "haidar-promote": "./assets/image/haidar-promote.png",
    "haidar-rpg": "./assets/image/haidar-rpg.jpg",
    "haidar-rules": "./assets/image/haidar-rules.jpg",
    "haidar-store": "./assets/image/haidar-store.png",
    "haidar-v8": "./assets/image/haidar-v8.jpg",
    "haidar-winner": "./assets/image/haidar-winner.jpg",
    "haidar": "./assets/image/haidar.png",
    "haidar2": "./assets/image/haidar2.jpg",
    "haidar3": "./assets/image/haidar3.jpg",
    "pp-kosong": "./assets/image/pp-kosong.jpg",
    "haidar-mp4": "./assets/video/haidar-mp4.mp4",
    "haidar-mp3": "./assets/audio/haidar-mp3.mp3",
    "haidar-font": "./assets/haidar-font.ttf",
    "haidar-kertas": "./assets/image/haidar-kertas.jpg",
  ...
  sticker: {
    packname: "𝗧𝗘𝗡𝗞𝗔 𝗠𝗗", // Nama pack sticker
    author: "haidar", // Author sticker
  },

  saluran: {
    id: "120363405683815121@newsletter", // ID saluran (contoh: 120363xxx@newsletter)                          // ID saluran (contoh: 120363xxx@newsletter)
    name: "Join saluran resmi haidar", // Nama saluran
    link: "https://whatsapp.com/channel/0029VbCFebx5vKAE6kYKbm12", // Link saluran
  },
