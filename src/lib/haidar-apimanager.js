...
/**
 * @typedef {Object} HaidarApiAuthShape
 * @property {Object<string, any>} [headers]
 * @property {Object<string, any>} [params]
 */

/**
 * @typedef {Object} HaidarApiProviderShape
 * @property {string} baseURL
 * @property {HaidarApiAuthShape} [auth]
...
/**
 * @typedef {Object} HaidarApiRequestOptions
...
/**
 * @typedef {Object} HaidarApiMultipartFile
 ...
 */
class HaidarApiProvider {
  /**
   * @param {HaidarApiManager} mgr
   * @param {string} name
   */
  ...
  /**
   * @param {string} ep
   * @param {HaidarApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
  request(ep, opt = {}) {
   ...
   * @param {HaidarApiMultipartFile[]|Object<string, any>} [files]
   * @param {HaidarApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
...
class CovenantApiProvider extends HaidarApiProvider {
  gpt4(input, opt = {}) {
...
class NeoxrApiProvider extends HaidarApiProvider {
  whatMusic(input, opt = {}) {
...
class CukiApiProvider extends HaidarApiProvider {
...
class ApiFaaProvider extends HaidarApiProvider {
...
class HaidarMainApiProvider extends HaidarApiProvider {
  ytmp4(input, opt = {}) {
...
class NexrayApiProvider extends HaidarApiProvider {
  geminiTts(input, opt = {}) {
...
class YupraApiProvider extends HaidarApiProvider {
  brat(input, opt = {}) {
    return this.get("/api/image/brat", this.asParams(input, "text"), opt);
  }
}

class EmiliabotApiProvider extends HaidarApiProvider {
...
class AzbryApiProvider extends HaidarApiProvider {
...
class YuulabsApiProvider extends HaidarApiProvider {
  tiktok(input, opt = {}) {
    return this.get("/api/downloader/tiktok", this.asParams(input, "url"), opt);
  }
}

class ZenzxzApiProvider extends HaidarApiProvider {
  youtube(input, opt = {}) {
...
class FgsiApiProvider extends HaidarApiProvider {
...
/**
 * API manager terpusat untuk provider eksternal Haidar.
 */
class HaidarApiManager {
  /**
  ...
  /**
   * @param {string} name
   * @returns {HaidarApiProviderShape}
   */
  ...
  /**
   * @param {string} name
   * @param {HaidarApiProviderShape} cfg
   * @returns {HaidarApiProvider}
   */
  ...
  /**
   * @param {string} name
   * @param {Partial<HaidarApiProviderShape>} cfg
   * @returns {HaidarApiProvider}
   */
  ...
  makeProviderClient(name) {
    const ProviderClass = this.providerClasses?.[name] || HaidarApiProvider;
  ...
  makeProviders() {
    return {
      ...
      haidar: {
        baseURL: "https://api.haidar.my.id",
      },
    };
  }
...
const haidarApi = new HaidarApiManager();

export { HaidarApiManager, HaidarApiProvider, haidarApi };
export default haidarApi;
