...
footer: Powered by Haidar AI (opsional)
[/RICH:CODE]
...
[RICH:LIST]
title: Info Bot
rows: Nama | Haidar AI;; Versi | 2.4.5;; Developer | haidar
footer: © Haidar AI (opsional)
[/RICH:LIST]

5. STICKER (saat user minta sticker, atau untuk ekspresi emosi):
[RICH:STICKER]
url: https://iili.io/BPBdFuj.md.jpg
packname: Haidar AI (opsional)
  ...
  try {
    ...
    if (rich.type === "STICKER") {
      ...
      await sock.sendImageAsSticker(jid, stickerInput, quoted, {
        packname: packname || config.bot?.name || "Haidar AI",
    ...
    case "STICKER": {
      ...
      await sock.sendMessage(
        m.chat,
        {
          ...
          packname: config.bot?.name || "Haidar",
          author: "AutoAI",
        },
        { quoted: m },
      );
