...
import { isLid, lidToJid, lidToJidSafe } from "./haidar-lid.js";
    ...
    try {
      ...
      if (msgContent) {
        ...
        if (
          ...
          const { downloadMediaMessage } = await import("haidar");
          const fakeMsg = {
            key: cached.key,
          ...
          const { generateWAMessageFromContent } = await import("haidar");
          const cleanContent = {};
