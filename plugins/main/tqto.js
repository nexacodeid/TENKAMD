...
async function handler(m, { sock }) {
    ...
    const developer = config.bot?.developer || 'Haidar'

    const credits = [
        { name: 'Haidar', role: 'Developer Tenka MD dan Rename Ourin MD😹', icon: '👨‍💻' },
        { name: 'hyuuOkkotsuX', role: 'Lead Staff', icon: '👨‍💻' },
        { name: 'ourin', role: 'Creator Ourin MD dan APK Stardem Ourin', icon: '👨‍💻' },
        ...
        { name: 'Haidar', role: 'Youtuber', icon: '🌐' },
