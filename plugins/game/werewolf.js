...
try {
  ...
  if (fs.existsSync(path.join(assetsPath, "haidar.jpg"))) {
    thumbNight = fs.readFileSync(path.join(assetsPath, "haidar.jpg"));
    thumbDay = fs.readFileSync(path.join(assetsPath, "haidar.jpg"));
  }
  if (fs.existsSync(path.join(assetsPath, "haidar-winner.jpg"))) {
    thumbWin = fs.readFileSync(path.join(assetsPath, "haidar-winner.jpg"));
  }
} catch (e) {
